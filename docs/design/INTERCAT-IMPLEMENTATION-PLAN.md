...
| Active channels/peers | Distinct channel/entity instances under the selected interval and evidence policy. A peer is a process instance at the other end of a proven relation, counted as a lower bound beside the records whose other end is unresolved; a channel is a connection incarnation and needs its lifetime |

...
**The timeline follows the rung too.** L0 draws mechanism lanes as of revision 119, and L1 draws exact
process-owner lanes as of revision 122. Every deeper rung retains an exact focus count for the records E reads:

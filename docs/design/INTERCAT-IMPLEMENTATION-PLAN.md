...
Dragging the brush moves the viewport, dragging an edge resizes it, a press beside it centres it there, and a double press fits (§6.7). Keyboard users keep the timeline's keys.
